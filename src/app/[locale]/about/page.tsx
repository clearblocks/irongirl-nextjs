    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 bg-white">
        <div className="max-w-4xl mx-auto px-6 py-16">
          <h2 className="font-hero text-4xl text-primary mb-6">About IronGirl</h2>
          ...
          <div className="space-y-6">
            ...
            <h3 className="font-header text-2xl text-header mt-8 mb-4">Public Area</h3>
            ...
            <h3 className="font-header text-2xl text-header mt-8 mb-4">Admin Area</h3>
            <p className="font-sans text-base text-foreground">
