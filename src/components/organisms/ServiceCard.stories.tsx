...
export const Washing: Story = {
  args: {
    ...
    description:
      'Laat je was zorgeloos aan ons over voor een frisse en schone garderobe.',
    buttonLabel: 'Meer',
    onClick: () => console.log('Washing service clicked'),
  },
};
...
export const Ironing: Story = {
  args: {
    ...
    description:
      'Professioneel strijkwerk voor kledij die er perfect uitziet.',
    buttonLabel: 'Meer',
    onClick: () => console.log('Ironing service clicked'),
  },
};
...
export const DryCleaning: Story = {
  args: {
    ...
    description:
      'Delicate stoffen verdienen de beste zorg met onze stoomreiniging.',
    buttonLabel: 'Meer',
    onClick: () => console.log('Dry cleaning service clicked'),
  },
};
...
export const ShortDescription: Story = {
  args: {
    ...
    onClick: () => console.log('Express service clicked'),
  },
};
